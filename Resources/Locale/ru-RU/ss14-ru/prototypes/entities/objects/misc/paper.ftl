...
ent-PaperSalvageJobLabel = этикетка по заданию спасения
    .desc = Бумажная этикетка, обозначающая ящик как содержащий груз для выполнения задания по спасению. Продажа ящика с этой этикеткой выполнит задание.
